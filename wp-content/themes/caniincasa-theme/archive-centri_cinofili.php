<?php
/**
 * Template for Centri Cinofili Archive
 *
 * @package Caniincasa
 */
        ...
        <div class="archive-content-wrapper">
            ...
            <aside class="strutture-filters-sidebar">
                ...
                <div class="filters-box">
                    ...
                    <form id="centri-filters-form" class="filters-form">
                        ...
                        <input type="hidden" name="action" value="filter_centri" />
                        <input type="hidden" name="nonce" value="<?php echo wp_create_nonce( 'filter_centri_nonce' ); ?>" />
            ...
            <div class="strutture-main-content">
                ...
                <div class="results-header">
                    <span class="results-count">
                        <span id="centri-count"><?php echo $wp_query->found_posts; ?></span> centri trovati
                    </span>
                ...
                <!-- Loading Overlay -->
                <div id="centri-loading" class="loading-overlay" style="display: none;">
                    <div class="loader"></div>
                    <p>Caricamento centri...</p>
                </div>

                <!-- Centri Grid -->
                <div id="centri-grid" class="strutture-grid view-grid">
                    <?php
                    if ( have_posts() ) :
                        while ( have_posts() ) :
                            the_post();
                ...
                <div id="centri-pagination-container">
                    <?php
...
jQuery(document).ready(function($) {
    ...
    const $form = $('#centri-filters-form');
    const $grid = $('#centri-grid');
    const $loading = $('#centri-loading');
    const $count = $('#centri-count');
    const $paginationContainer = $('#centri-pagination-container');
    ...
    $(document).on('click', '.strutture-pagination a.pagination-link', function(e) {
        ...
        $('html, body').animate({
            scrollTop: $('.archive-centri-cinofili').offset().top - 100
        }, 500);
    });
});
</script>
