...
<main id="main-content" class="site-main archive-strutture archive-canili">

    <!-- Archive Header -->
    <div class="archive-header">
        <div class="container">
            <h1 class="archive-title">Canili</h1>
            <p class="archive-description">Trova canili e rifugi in tutta Italia</p>
        </div>
    </div>
        ...
        <div class="archive-content-wrapper">
            ...
            <aside class="strutture-filters-sidebar">
                ...
                <div class="filters-box">
                    ...
                    <form id="canili-filters-form" class="filters-form">
                        ...
                        <input type="hidden" name="action" value="filter_canili" />
                        <input type="hidden" name="nonce" value="<?php echo wp_create_nonce( 'filter_canili_nonce' ); ?>" />
            ...
            <div class="strutture-main-content">
                ...
                <div class="results-header">
                    <span class="results-count">
                        <span id="canili-count"><?php echo $wp_query->found_posts; ?></span> canili trovati
                    </span>
                ...
                <!-- Loading Overlay -->
                <div id="canili-loading" class="loading-overlay" style="display: none;">
                    <div class="loader"></div>
                    <p>Caricamento canili...</p>
                </div>

                <!-- Canili Grid -->
                <div id="canili-grid" class="strutture-grid view-grid">
                    <?php
                    if ( have_posts() ) :
                        while ( have_posts() ) :
                            the_post();
                ...
                <div id="canili-pagination-container">
                    <?php
...
jQuery(document).ready(function($) {
    ...
    const $form = $('#canili-filters-form');
    const $grid = $('#canili-grid');
    const $loading = $('#canili-loading');
    const $count = $('#canili-count');
    const $paginationContainer = $('#canili-pagination-container');
    ...
    $(document).on('click', '.strutture-pagination a.pagination-link', function(e) {
        ...
        $('html, body').animate({
            scrollTop: $('.archive-canili').offset().top - 100
        }, 500);
    });
});
</script>
