<?php
/**
 * Template for Toelettature Archive
 *
 * @package Caniincasa
 */
...
<main id="main-content" class="site-main archive-strutture archive-toelettature">

    <!-- Archive Header -->
    <div class="archive-header">
        <div class="container">
            <h1 class="archive-title">Toelettature</h1>
            <p class="archive-description">Trova toelettature e servizi di grooming per cani in tutta Italia</p>
        </div>
    </div>
            ...
            <aside class="strutture-filters-sidebar">
                ...
                <div class="filters-box">
                    <div class="filters-header">
                        <h3>🔍 Filtra Toelettature</h3>
                        <button class="filters-reset" id="reset-filters">
                            Resetta
                        </button>
                    </div>

                    <form id="toelettature-filters-form" class="filters-form">
                        ...
                        <input type="hidden" name="action" value="filter_toelettature" />
                        <input type="hidden" name="nonce" value="<?php echo wp_create_nonce( 'filter_toelettature_nonce' ); ?>" />
            ...
            <div class="strutture-main-content">
                ...
                <div class="results-header">
                    <span class="results-count">
                        <span id="toelettature-count"><?php echo $wp_query->found_posts; ?></span> toelettature trovate
                    </span>
                ...
                <!-- Loading Overlay -->
                <div id="toelettature-loading" class="loading-overlay" style="display: none;">
                    <div class="loader"></div>
                    <p>Caricamento toelettature...</p>
                </div>

                <!-- Toelettature Grid -->
                <div id="toelettature-grid" class="strutture-grid view-grid">
                    <?php
                    if ( have_posts() ) :
                        while ( have_posts() ) :
                            the_post();
                ...
                <div id="toelettature-pagination-container">
                    <?php
...
jQuery(document).ready(function($) {
    ...
    const $form = $('#toelettature-filters-form');
    const $grid = $('#toelettature-grid');
    const $loading = $('#toelettature-loading');
    const $count = $('#toelettature-count');
    const $paginationContainer = $('#toelettature-pagination-container');
    ...
    // Load toelettature AJAX
    function loadToelettature(page = 1) {
        $loading.show();
    ...
    $(document).on('click', '.strutture-pagination a.pagination-link', function(e) {
        ...
        loadToelettature(page);

        // Scroll to top smoothly
        $('html, body').animate({
            scrollTop: $('.archive-toelettature').offset().top - 100
        }, 500);
    });
});
</script>
