<?php
/**
 * Template for Aree Cani Archive
 *
 * @package Caniincasa
 */
...
<main id="main-content" class="site-main archive-strutture archive-aree-cani">

    <!-- Archive Header -->
    <div class="archive-header">
        <div class="container">
            <h1 class="archive-title">Aree Cani</h1>
            <p class="archive-description">Trova aree cani e spazi pubblici per cani in tutta Italia</p>
        </div>
    </div>
            ...
            <aside class="strutture-filters-sidebar">
                ...
                <div class="filters-box">
                    <div class="filters-header">
                        <h3>🔍 Filtra Aree Cani</h3>
                        <button class="filters-reset" id="reset-filters">
                            Resetta
                        </button>
                    </div>

                    <form id="aree-cani-filters-form" class="filters-form">
                        ...
                        <input type="hidden" name="action" value="filter_aree_cani" />
                        <input type="hidden" name="nonce" value="<?php echo wp_create_nonce( 'filter_aree_cani_nonce' ); ?>" />
            ...
            <div class="strutture-main-content">
                ...
                <div class="results-header">
                    <span class="results-count">
                        <span id="aree-cani-count"><?php echo $wp_query->found_posts; ?></span> aree cani trovate
                    </span>
                ...
                <!-- Loading Overlay -->
                <div id="aree-cani-loading" class="loading-overlay" style="display: none;">
                    <div class="loader"></div>
                    <p>Caricamento aree cani...</p>
                </div>

                <!-- Aree Cani Grid -->
                <div id="aree-cani-grid" class="strutture-grid view-grid">
                    <?php
                    if ( have_posts() ) :
                        while ( have_posts() ) :
                            the_post();
                ...
                <div id="aree-cani-pagination-container">
                    <?php
...
jQuery(document).ready(function($) {
    ...
    const $form = $('#aree-cani-filters-form');
    const $grid = $('#aree-cani-grid');
    const $loading = $('#aree-cani-loading');
    const $count = $('#aree-cani-count');
    const $paginationContainer = $('#aree-cani-pagination-container');
    ...
    $(document).on('click', '.strutture-pagination a.pagination-link', function(e) {
        ...
        $('html, body').animate({
            scrollTop: $('.archive-aree-cani').offset().top - 100
        }, 500);
    });
});
</script>
