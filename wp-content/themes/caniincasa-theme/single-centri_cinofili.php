<?php
/**
 * Template for Single Centro Cinofilo
 *
 * @package Caniincasa
 */
            ...
            <div class="struttura-content-wrapper">
                ...
                <div class="struttura-main-content">
                    ...
                    <div class="struttura-info-box">
                        ...
                        <div class="info-grid">
                            ...
                            <?php if ( $indirizzo || $comune || $provincia ) : ?>
                ...
                <aside class="struttura-sidebar">
                    ...
                    <div class="sidebar-box back-search-box">
                        <h3 class="box-title">Cerca Altri Centri</h3>
                        <p>Torna all'archivio per cercare altri centri cinofili.</p>
                        <a href="<?php echo esc_url( get_post_type_archive_link( 'centri_cinofili' ) ); ?>" class="btn btn-secondary btn-block">
                    ...
                    <div class="sidebar-box preferiti-action-box">
                        <h3 class="box-title">Ti piace questo centro?</h3>
                        <?php echo caniincasa_get_preferiti_button( get_the_ID(), 'centri_cinofili' ); ?>
                    </div>
                    <?php endif; ?>

                    <!-- Proponi Struttura Box -->
                    <div class="sidebar-box proponi-box">
                        <h3 class="box-title">Hai un centro cinofilo?</h3>
